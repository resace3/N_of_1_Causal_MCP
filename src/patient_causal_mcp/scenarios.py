...
SCENARIOS: dict[str, ScenarioDefinition] = {
    ...
    "homer_late_screen_sleep": ScenarioDefinition(
        name="homer_late_screen_sleep",
        description=(
            "Synthetic Homer parody scenario where stress and prior fatigue increase late-night "
            "screen time, which worsens same-night sleep quality and next-day fatigue."
        ),
        causal_question=(
            "In the synthetic Homer household data, what is the effect of late-night screen "
            "time on next-day fatigue?"
        ),
        exposure="late_night_screen_minutes",
        outcome="outcome_next_day_fatigue",
        confounders=[
        ...
        mediators=["sleep_duration_hours", "sleep_quality"],
        expected_direction="More late-night screen time is expected to increase next-day fatigue.",
        example_interpretation=(
            "This is a synthetic demo question; estimates reflect the generated causal process, "
            "not any real person's behavior."
        ),
        dag_edges=[
            ("prior_sleep_quality", "late_night_screen_minutes"),
            ("prior_sleep_quality", "outcome_next_day_fatigue"),
            ("prior_fatigue", "late_night_screen_minutes"),
            ("prior_fatigue", "outcome_next_day_fatigue"),
            ("prior_stress_score", "late_night_screen_minutes"),
            ("prior_stress_score", "outcome_next_day_fatigue"),
            ("is_workday", "late_night_screen_minutes"),
            ("is_workday", "outcome_next_day_fatigue"),
            ("caffeine_mg", "outcome_next_day_fatigue"),
            ("late_night_screen_minutes", "sleep_quality"),
            ("sleep_quality", "outcome_next_day_fatigue"),
            ("late_night_screen_minutes", "outcome_next_day_fatigue"),
        ],
        variables_not_to_adjust_for=["sleep_duration_hours", "sleep_quality"],
    ),
    "homer_walk_nudge_mood": ScenarioDefinition(
        name="homer_walk_nudge_mood",
        description=(
            "Synthetic target-trial scenario for walk nudges among low-activity, high-fatigue days."
        ),
        causal_question=(
            "In the synthetic Homer data, what is the effect of receiving a walk nudge on "
            "next-day mood?"
        ),
        ...
        mediators=["steps", "active_minutes"],
        expected_direction="Walk nudges are expected to improve next-day mood through activity.",
        dag_edges=[
            ("prior_fatigue", "walk_nudge_received"),
            ("prior_fatigue", "outcome_mood_next_day"),
            ("prior_steps", "walk_nudge_received"),
            ("prior_steps", "outcome_mood_next_day"),
            ("prior_stress_score", "walk_nudge_received"),
            ("prior_stress_score", "outcome_mood_next_day"),
            ("is_workday", "walk_nudge_received"),
            ("is_workday", "outcome_mood_next_day"),
            ("baseline_activity_level", "walk_nudge_received"),
            ("baseline_activity_level", "outcome_mood_next_day"),
            ("walk_nudge_received", "steps"),
            ("steps", "outcome_mood_next_day"),
            ("walk_nudge_received", "outcome_mood_next_day"),
        ],
        variables_not_to_adjust_for=["steps", "active_minutes"],
    ),
    "homer_caffeine_sleep": ScenarioDefinition(
        name="homer_caffeine_sleep",
        description="Synthetic Homer scenario for caffeine burden and sleep quality.",
        causal_question=(
            "In the synthetic Homer data, what is the effect of higher caffeine intake on "
            "same-night sleep quality?"
        ),
        exposure="caffeine_mg",
        outcome="outcome_sleep_quality",
        confounders=["prior_fatigue", "prior_sleep_quality", "prior_stress_score", "is_workday"],
        expected_direction="Higher caffeine is expected to lower sleep quality.",
        dag_edges=[
            ("prior_fatigue", "caffeine_mg"),
            ("prior_fatigue", "outcome_sleep_quality"),
            ("prior_sleep_quality", "caffeine_mg"),
            ("prior_sleep_quality", "outcome_sleep_quality"),
            ("prior_stress_score", "caffeine_mg"),
            ("prior_stress_score", "outcome_sleep_quality"),
            ("is_workday", "caffeine_mg"),
            ("is_workday", "outcome_sleep_quality"),
            ("caffeine_mg", "outcome_sleep_quality"),
        ],
    ),
    "homer_illuminance_sleep": ScenarioDefinition(
        name="homer_illuminance_sleep",
        description="Synthetic Homer scenario for daytime outdoor illuminance and sleep quality.",
        causal_question=(
            "In the synthetic Homer data, what is the effect of daytime outdoor illuminance "
            "exposure on sleep quality?"
        ),
        exposure="avg_daytime_outdoor_illuminance",
        outcome="outcome_sleep_quality",
        confounders=["is_workday", "prior_fatigue", "prior_steps", "prior_stress_score"],
        mediators=["active_minutes"],
        expected_direction="More daytime illuminance is expected to improve sleep quality.",
        dag_edges=[
            ("is_workday", "avg_daytime_outdoor_illuminance"),
            ("is_workday", "outcome_sleep_quality"),
            ("prior_fatigue", "avg_daytime_outdoor_illuminance"),
            ("prior_fatigue", "outcome_sleep_quality"),
            ("prior_steps", "avg_daytime_outdoor_illuminance"),
            ("prior_steps", "outcome_sleep_quality"),
            ("prior_stress_score", "avg_daytime_outdoor_illuminance"),
            ("prior_stress_score", "outcome_sleep_quality"),
            ("avg_daytime_outdoor_illuminance", "active_minutes"),
            ("active_minutes", "outcome_sleep_quality"),
            ("avg_daytime_outdoor_illuminance", "outcome_sleep_quality"),
        ],
        variables_not_to_adjust_for=["active_minutes"],
    ),
    "homer_tv_fatigue": ScenarioDefinition(
        name="homer_tv_fatigue",
        description="Synthetic Homer scenario for evening TV time and next-day fatigue.",
        causal_question=(
            "In the synthetic Homer data, what is the effect of TV minutes on next-day fatigue?"
        ),
        exposure="tv_minutes",
        outcome="outcome_next_day_fatigue",
        confounders=[
        ...
        mediators=["late_night_screen_minutes", "sleep_quality"],
        expected_direction="More TV time is expected to increase next-day fatigue.",
        dag_edges=[
            ("prior_fatigue", "tv_minutes"),
            ("prior_fatigue", "outcome_next_day_fatigue"),
            ("prior_sleep_quality", "tv_minutes"),
            ("prior_sleep_quality", "outcome_next_day_fatigue"),
            ("prior_stress_score", "tv_minutes"),
            ("prior_stress_score", "outcome_next_day_fatigue"),
            ("is_weekend", "tv_minutes"),
            ("is_weekend", "outcome_next_day_fatigue"),
            ("caffeine_mg", "outcome_next_day_fatigue"),
            ("tv_minutes", "late_night_screen_minutes"),
            ("late_night_screen_minutes", "sleep_quality"),
            ("sleep_quality", "outcome_next_day_fatigue"),
            ("tv_minutes", "outcome_next_day_fatigue"),
        ],
        variables_not_to_adjust_for=["late_night_screen_minutes", "sleep_quality"],
    ),
}
...
VARIABLE_DESCRIPTIONS: dict[str, str] = {
    ...
    "is_workday": "Indicator for Monday through Friday synthetic work-shift days.",
    "patient_id": "Synthetic patient identifier.",
    "subject_id": "Synthetic subject identifier for the fictional parody profile.",
    "synthetic_profile": "Synthetic profile class; Homer data uses fictional_parody.",
    ...
    "heart_rate_mean": "Mean heart rate from synthetic wearable samples.",
    "heart_rate_max": "Maximum heart rate from synthetic wearable samples.",
    ...
    "home_minutes": "Estimated minutes spent at the fictional synthetic home.",
    "away_minutes": "Estimated minutes away from the fictional synthetic home.",
    "work_minutes": "Estimated minutes in the fictional work zone.",
    ...
    "distance_traveled_miles": "Estimated daily distance traveled in miles.",
    ...
    "soda_intake_count": "Synthetic count of soda intake proxy events.",
    ...
    "front_door_opens": "Synthetic count of front-door open transitions.",
    "kitchen_motion_events": "Synthetic count of kitchen motion events.",
    "living_room_motion_events": "Synthetic count of living-room motion events.",
    "bedroom_motion_events": "Synthetic count of bedroom motion events.",
    "smart_plug_tv_minutes": "Estimated TV use minutes from a smart plug.",
    "tv_minutes": "Estimated TV minutes from synthetic smart plug and media states.",
    "streaming_minutes": "Synthetic streaming media minutes.",
    "smart_plug_kettle_uses": "Estimated electric kettle uses from smart plug current signatures.",
    "kettle_uses": "Synthetic count of kettle or coffee-maker use events.",
    "microwave_uses": "Synthetic count of microwave use events.",
    "medication_cabinet_opens": "Medication cabinet sensor open count.",
    "medicine_cabinet_opens": "Medication cabinet contact open count.",
    "avg_living_room_illuminance": "Daily mean living-room illuminance in lux.",
    "avg_bedroom_illuminance": "Daily mean bedroom illuminance in lux.",
    "avg_daytime_outdoor_illuminance": "Mean daytime outdoor illuminance in lux.",
    "avg_bedroom_temperature": "Mean bedroom temperature in Celsius.",
    "avg_indoor_co2": "Mean indoor carbon dioxide estimate in ppm.",
    "max_kitchen_pm25": "Maximum kitchen PM2.5 estimate in micrograms per cubic meter.",
    ...
    "game_app_minutes": "Minutes spent in games.",
    "navigation_minutes": "Minutes spent in navigation apps.",
    ...
    "work_stress_proxy": "Synthetic work stress proxy score.",
    "shift_load": "Synthetic work-shift load score.",
    "car_trips": "Synthetic count of car trips.",
    "car_minutes": "Synthetic car ignition-on minutes.",
    "car_miles": "Synthetic car miles.",
    "hard_brakes": "Synthetic hard-braking event count.",
    "idle_minutes": "Synthetic car idling minutes.",
    "intervention_received": "Binary indicator for an evening reminder or digital intervention.",
    "intervention_type": "Synthetic intervention label for the day's policy-assigned nudge.",
    "sleep_nudge_received": "Binary indicator for a synthetic sleep nudge.",
    "walk_nudge_received": "Binary indicator for a synthetic walk nudge.",
    "caffeine_nudge_received": "Binary indicator for a synthetic caffeine nudge.",
    ...
    "prior_late_screen_minutes": "Previous day's late-night screen minutes.",
    "prior_steps": "Previous day's total steps.",
    "prior_stress_score": "Previous day's stress score.",
